...
from airsim_env import AirSimPx4Env
...
'''启动px4:PX4-Autopilot文件夹下执行make px4_sitl_default none_iris'''
"""用mavlink向px4发布指令"""
...
def main():
    ...
    # 初始化
    airsim_environment = AirSimPx4Env(cfg)
